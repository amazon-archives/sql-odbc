...
cmake .\aws-sdk-cpp -A Win32 -D CMAKE_INSTALL_PREFIX=C:\Development\Projects\Amazon\ESODBC\sdk-build32\AWSSDK\ -D CMAKE_BUILD_TYPE=Release -D BUILD_ONLY="core" -D CUSTOM_MEMORY_MANAGEMENT="OFF" -D ENABLE_RTTI="OFF" -D ENABLE_TESTING="OFF"
