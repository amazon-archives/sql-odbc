...
int test_incoming_no_op_valid(int, char*[]);
int test_incoming_application_data_no_headers_valid(int, char*[]);
int test_incoming_application_one_compressed_header_pair_valid(int, char*[]);
int test_incoming_application_int32_header_valid(int, char*[]);
int test_outgoing_no_op_valid(int, char*[]);
int test_outgoing_application_data_no_headers_valid(int, char*[]);
int test_outgoing_application_one_compressed_header_pair_valid(int, char*[]);
int test_streaming_decoder_incoming_no_op_valid_single_message(int, char*[]);
int test_streaming_decoder_incoming_application_no_headers(int, char*[]);
int test_streaming_decoder_incoming_application_one_compressed_header_pair_valid(int, char*[]);
int test_streaming_decoder_incoming_multiple_messages(int, char*[]);
